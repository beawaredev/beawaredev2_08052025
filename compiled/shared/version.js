export function getVersionInfo() {
    ...
    const buildHash = process.env.GITHUB_SHA || process.env.BUILD_SOURCEVERSION || 'dev';
    const buildRef = process.env.GITHUB_REF || process.env.BUILD_SOURCEBRANCH || 'refs/heads/main';
    const buildNumber = process.env.GITHUB_RUN_NUMBER || process.env.BUILD_BUILDNUMBER;
...
export function formatVersionDisplay(versionInfo) {
...
export function getShortVersion(versionInfo) {
